...
if g != k:
    if g > k:
        print('Вы ввели число = ', g, ', которое ,больше сгенерированного числа', sep='')
if g < k:
    if g != k:
        print('Вы ввели число = ', g, ', которое меньше сгенерированного числа', sep='')
if g == k:
    print('Вы ввели число = ', g, ', которое равно сгенерированному числу', sep='')
